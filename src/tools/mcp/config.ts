...
/**
 * URL server configuration (alias for HTTP Streamable transport)
 */
...
export type UrlServerConfig = z.infer<typeof UrlServerConfigSchema>;
...
export const McpServerConfigSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('url'), config: UrlServerConfigSchema }),
...
export function detectTransportType(
  config: StdioServerConfig | SseServerConfig | HttpServerConfig | UrlServerConfig | WebSocketServerConfig
): 'stdio' | 'sse' | 'http' | 'url' | 'websocket' {
